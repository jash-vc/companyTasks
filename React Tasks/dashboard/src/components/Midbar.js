...
import { ReactComponent as SearchIcon } from "../assets/images/svg/search-white.svg";
import { ReactComponent as DesktopIcon } from "../assets/images/svg/desktop-icon.svg";
import { ReactComponent as MobileIcon } from "../assets/images/svg/phone-icon.svg";
import { ReactComponent as UserIcon } from "../assets/images/svg/user-icon.svg";
import styled from "styled-components";

const Badge = styled.div`
  background-color: ${(props) =>
    props.green ? "#18393a" : props.red ? "#bf2f2f" : "#694df3"};
  border-color: ${(props) =>
    props.greenborder ? "#20ffb2" : props.redborder ? "#ac5b5b" : "#b2b2fe"};
  box-shadow: ${(props) =>
    props.greenShadow
      ? "0 3px 3.5px rgb(32 255 178 / 20%)"
      : props.redShadow
      ? "0 3px 3.5px rgb(255 0 0 / 40%)"
      : "0 3px 3.5px rgb(13 19 255 / 64%)"};
  color: #fff;
  border-radius: 4px;
  border-width: 1px;
  border-style: solid;
...
export default function Midbar() {
  return (
    <div className="midbarContainer text-white mx-3 d-inline-block">
      ...
      <List className="cardsContainer" type="unstyled">
